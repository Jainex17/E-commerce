...
<body>
    ...
    <header class="header" id="header">
            ...
            <div class="header-title"><h3>Sub-Category</h3></div>
            ...
            <nav class="nav">
                <div> 
                    ...
                    <div class="nav_list">
                        ...
                        <a href="sub-category.php" class="nav_link active"> <i class='bx bx-folder nav_icon'></i> <span class="nav_name">Sub-Category</span> </a>
        ...
        <div class="add-product d-flex justify-content-end px-5">
            <a href="up-ins-del/add-subcat.php">
                       <button type="button" class="btn btn-warning">ADD SUB-CATEGORY</button>
                   </a>
            </div> 
        <table align="center">
                ...
                <tbody class="t_body">
                    ...
                    <?php
                    $select = "SELECT * FROM `sub-catagory`;";
